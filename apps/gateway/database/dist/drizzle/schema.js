...
export const user = pgTable('user', {
    ...
    activeProfileIdKey: uniqueIndex('User_activeProfileId_key').on(table.activeProfileId),
...
export const profile = pgTable('profile', {
    ...
    profileNumberKey: uniqueIndex('Profile_profileNumber_key').on(table.profileNumber),
    userIdShopIdKey: uniqueIndex('Profile_userId_shopId_key').on(table.userId, table.shopId),
    operatorActiveProfileIdx: index('operator_active_profile_idx').on(table.shopId, table.isActive),
    profileNumberIdx: index('profile_number_idx').on(table.profileNumber),
    userActiveProfileIdx: index('user_active_profile_idx').on(table.userId, table.isActive),
