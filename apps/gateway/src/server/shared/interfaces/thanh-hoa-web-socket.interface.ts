...
import { WebSocketMiddleware } from "../../../../websocket/src";
import { RouterHandler } from "../../core/router-handler.core";
...
export interface IThanhHoaWebSocket {
   ...
   */
  unsubscribe(ws: ServerWebSocket<ICashflowWebSocketData>, topic: string): void;
