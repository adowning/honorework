...
//       managerName: websocket.data.custom.user.activeProfile.shop.name,
//       initialCredits: websocket.data.custom.user.balance,
//       currentCredits: websocket.data.custom.user.balance,
//       entryTime: new Date(),
//       currentRTP: 0,
//       gameSessions: [],
//       createdAt: new Date(),
...
//       logger.info(`One WebSocket connection removed for user ${userId}`)
//       return this.sessions.size
//     } catch (error) {
//       logger.error(
//         `Error removing WebSocket connection for user ${userId}:`,
//         error,
//       )
//       return this.sessions.size
//     }
