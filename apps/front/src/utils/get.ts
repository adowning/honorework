...
const join = (segs: string[], joinChar: string, options: any): string => {
...
const split = (path: string, splitChar: string, options: any): string[] => {
...
const isValid = (key: string, target: any = {}, options: any): boolean => {
...
const isValidObject = (v: any): boolean => {
  return isObject(v) || typeof v === 'function'
}

// eslint-disable-next-line complexity
const getValue = (target: any, path: string | number | string[], options: Options = {}): any => {
  if (!isObject(options)) {
