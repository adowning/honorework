...
import {  GetUserData } from "@/interface/appBar";
...
const { setAuthModalType, setAuthDialogVisible, dispatchUserProfile, dispatchSignout } = authStore;
const {
  setRightBarToggle,
  setNavBarToggle,
  setOverlayScrimShow,
...
const { setBonusDashboardDialogVisible, getHeaderBlurEffectShow } = appBarStore
...
const rightBarToggle = computed<boolean>(() => {
...
const userNavToggle = computed<boolean>(() => {
...
const mobileVersion: any = computed(() => mobileWidth.value < 600)
...
const refferalAppBarShow = computed<boolean>(() => {
...
const goTransactionPage = () => {
  router.push({ name: 'Bonuses And Transactions' });
  setBonusTabIndex(1);
  setTransactionTab('Transactions');
}
...
const goWithdrawPage = () => {
  router.push({ name: 'Bonuses And Transactions' });
  setBonusTabIndex(1);
  setTransactionTab('Withdrawal');
}

const goGameHistoryPage = () => {
  router.push({ name: 'Bonuses And Transactions' });
  setBonusTabIndex(1);
  setTransactionTab('Game History');
}
...
// header blur effect
const headerBlurEffectShow = computed<boolean>(() => {
...
<template>  
  <div class="bg-[#1D2027] toolbar" :class="[appBarWidth, { 'header-bg-blur': headerBlurEffectShow },mobileWidth > 1200 ? 'pc-header-l' : '', 'app-bar-height',]">
    <div
            v-if="!navBarToggle && mobileWidth > 600"
            class="cursor-pointer"
            style="display:flex;align-items:center;"
            @click="setNavBarToggle(true)"

    >
       <img src="@/assets/public/svg/icon_public_57.svg" />
    </div>
      ...
      <div class="flex items-center">
        <div class="deposit-menu" >
          ...
          <div
              ...
              v-if="mobileWidth > 600" style="width:400px">
              <div class="deposit-item user-card-height pr-1" style="display:flex;align-items:center;">
                  <div class="flex items-center">
                    <div class="relative">
                      <div @click="currencyMenuShow = !currencyMenuShow">
                          <div class="flex items-center text-700-16" style="height: 40px">
             ...
             <div
              class="m-user-card-height mt-2 "
              style="border-radius: 8px;background-color:#15161C;"
          ...
          <div class="user-menu" >
             <div class="relative user-menu-container" >
              <div class="user-card-container" v-if="mobileWidth > 600">
               <div class="mr-4 mt-1 user-card-height">
                <div class="user-item user-card-height">
                <div class="d-flex align-center">
                  <img :src="user.avatar" class="user-avatar-width" />

                  <div class="ml-4" style="display:flex; flex-direction:column;align-items:flex-start;">
          ...
          <div class="dropdown-content px-2">
            ...
            </div> <div class="ml-2"> ID : {{ userInfo.uid }}</div>
               <div >
                <img
                  @click="inviteUrlCopy(userInfo.uid)"
                  src="@/assets/public/svg/icon_public_71.svg"
                  class="ml-6" />
              </div></div> <div class="user-item" value="vip">
                <div class="user-card-container text-center">
              ...
              <v-list-item-title class="ml-2">
                <div class="deposit-progress-bg">
                  <div class="d-flex">
                    ...
                    <div class="ml-auto">
                      <font>R$ 5642</font> / <font color="#F9BC01">R$ 10000</font></div>
                  </div>
                  <div>
                ...
                <div class="deposit-progress-bg">
                  <div class="d-flex">
                    ...
                    <div class="ml-auto">
                      <font>R$ 5642</font> / <font color="#623AEC">R$ 10000</font></div>
                    </div>
                   <div>
            ...
            <div
              ...
              <div class="ml-2">Refer A Friend</div>
               <div >
                <img
        ...
        <div class="mail-menu" >
          ...
          <div  class="mail-container-dropdown px-2" width="400">
            <div
              class="mail-item"
            ...
            >
              <div class="prepend">
               ...
               <div class="ml-2 list-item-title">
                 <div>
    ...
    <div v-else>
    <label class="switch">
      <input type="checkbox" @change="toggleLanguage" :checked="currentLanguage === 'zh'" />
      ...
      <span
       ...
       <button
          ...
          :class="[mobileVersion ? 'app-bar-login-btn-mobile' : 'app-bar-login-btn', ]"
          class="text-none custom-login-button"
         >
          Login
       </button>
       <button
...
.currency-selected-item {
  ...
  border-radius: 0.875rem /* 14px */ !important;
}
...
.m-currency-menu {
  ...
  .overlay-content::after {
    ...
    top: -25px;
    right: 150px;
    border: 0.813rem /* 13px */ solid #1d2027;
...
.deposit-progress {
 /* .v-progress-linear__determinate {
    background: linear-gradient(180deg, rgb(249, 188, 1) 0%, rgb(249, 147, 1) 100%);
    border-radius: 20px;
  } */
}
...
.deposit-progress-bg {
    ...
    border-radius: 1.25rem /* 20px */ !important;
  }
}
